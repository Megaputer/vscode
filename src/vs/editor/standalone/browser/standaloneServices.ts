...
import { EditorCompletionService, IEditorCompletionService } from 'vs/editor/common/services/editorCompletionService';
...
registerSingleton(IEditorCompletionService, EditorCompletionService, InstantiationType.Eager);
